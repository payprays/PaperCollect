...
The default embedding path is FastEmbed with `jinaai/jina-embeddings-v3` dense embeddings and SPLADE sparse embeddings. Tests use deterministic hash embeddings to avoid model downloads.
